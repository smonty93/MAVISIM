...
<p class="admonition-title">Loading the input catalogue and specifying the exposure time</p>
<p> <code>>>> glob_clust = input_par.input_file </code><br>
<code>>>> exp_time = 30</code>
</p>
</div>
## Source Class
...
<div class="admonition note">
<p class="admonition-title">Creating a noise-free image</p>
<p><code> >>> image = ao_field + seeing_field </code></p>
</div>
